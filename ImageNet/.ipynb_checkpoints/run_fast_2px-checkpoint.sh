DATA160=../../Dataset/ILSVRC/Data/imagenet
DATA352=../../Dataset/ILSVRC/Data/imagenet
...
python -u main_fast_adv_MVIT.py $DATA160 -c $CONFIG1 --output_prefix $PREFIX1  | tee $OUT1
...
python -u main_fast_adv_MVIT.py $DATA352 -c $CONFIG2 --output_prefix $PREFIX2 --resume $END1| tee $OUT2
